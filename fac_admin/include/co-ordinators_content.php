...
$items_total_count = ($search == '') || !isset($_GET['search']) ? count($coordinators->find_by_query("SELECT * FROM coordinator WHERE faculty='{$user->faculty}' AND coordinate!='Faculty' ORDER BY id DESC")) : count($coordinators::find_by_query($sql));
...
$sql = ($search == '') || !isset($_GET['search']) ? "SELECT * FROM coordinator WHERE faculty='{$user->faculty}' AND coordinate!='Faculty' ORDER BY id DESC" : $sql;
			...
			<div class="col-12 col-xl-12">
				<div class="card ">
					<div class="card-header">
						...
						<?php
						include('include/components/add_coodinator_modal.php');
						include('include/components/edit_coodinator_modal.php');
						?>
						...
						<div class="mb-3">
							...
							<div class="row">
								<div class="col-md-6">
									<!-- BEGIN primary modal -->
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-coo">
										Add TT Officer
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-square align-middle mr-2">
							...
							<table style="font-size: 12px;" class=" mb-3 table table-striped table-hover">
								...
								<tbody>
									<tr title="<?php echo $coordinator->name; ?>" class="<?php $i++;
																							if ($i % 2 == 0) {
																								echo "table-primary";
																							} else {
																								echo "";
										...
										<td>
											<img src="img/avatars/avatar1.jpg" width="48" height="48" class="rounded-circle mr-2" alt="Avatar">
										...
										<td class="table-action">
											<a class="edit  text-primary" data-toggle="modal" data-target="#edit_coordinator" data=<?php echo $coordinator->id; ?>><i class="align-middle" data-feather="edit-2"></i></a>
											<a data-toggle="modal" data="coo/<?php echo $coordinator->id; ?>" data-target="#delete" class="deleteee text-danger"><i class="align-middle " data-feather="trash"></i></a>
										</td>
									</tr>
								<?php endforeach; ?>
