								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-header">
											<div id='add-dept-error'></div>
										</div>
									<div class="card-body">
					<form name="add-dept" action="" method="">
										...
										<div class="row">
											<div class="mb-3 col-md-6">
												...
												<select disabled name="faculty" id="faculty" class="form-control">
												<option value="" >Choose...</option>
												
													<option selected value="<?php echo $user->faculty ?>"><?php echo $user->faculty ?></option>
						...
						<div class="modal-footer">
							...
							<input id="add-dept" type="button" name="add-dept" value="Save" class="btn btn-primary">
						</div>
					</form>
				</div>
			</div>
