	...
	<div class="container-fluid p-0">
		...
		<div class="row mb-2 mb-xl-3">
			<div class="col-auto d-none d-sm-block">
				<h3><strong>Faculty(<?php echo $user->faculty ?>) Admin</strong> Dashboard</h3>
			</div>
			...
			<div class="col-xl-4 col-xl-4">
				<div class="card mb-3">
					...
					<div class="card-body text-center">
						<img src="img/avatars/avatar1.jpg" alt="Christina Mason" class="img-fluid rounded-circle mb-2"
							width="128" height="128" />
						<h5 class="card-title mb-0"><?php echo $user->name ?></h5>
						<div class="text-muted mb-2">Faculty of <strong><?php echo $user->faculty ?></strong> Time Table Coordinator</div>
									...
									<div class="card-header">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												<div style="font-size: 16px;" class="bg-primary badge"><?php echo count(Coordinator::find_by_query("SELECT * FROM coordinator WHERE faculty='{$user->faculty}'")) ?></div>
												<div>Timetable Officers</div>
											</div>
										</div>
									</div>
								...
								<div style="border:.1px solid rgba(50,50,50,.1)" class="card text-success">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												<div style="font-size: 16px;" class="bg-primary badge"><?php echo count(Department::find_by_query("SELECT * FROM department WHERE faculty='{$user->faculty}'")) ?></div>
												<div>Departments</div>
											</div>
										</div>
									</div>
								...
								<div style="border:.1px solid rgba(50,50,50,.1)" class="card text-danger">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												<div style="font-size: 16px;" class="bg-primary badge"><?php echo count(Venue::find_by_query("SELECT * FROM venue WHERE department IN (SELECT name FROM department WHERE faculty='{$user->faculty}')")) ?></div>
												<div>Venues</div>
											</div>
										</div>
									</div>
								...
								<div style="border:.1px solid rgba(50,50,50,.1)" class="card text-info">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-xs-9 text-right">
												<div style="font-size: 16px;" class="bg-primary badge"><?php echo count(Course::find_by_query("SELECT * FROM course WHERE department IN (SELECT name FROM department WHERE faculty='{$user->faculty}')")) ?></div>
												<div>Courses</div>
											</div>
										</div>
									</div>
