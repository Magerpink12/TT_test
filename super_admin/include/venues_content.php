...
$items_total_count = ($search=='') || !isset($_GET['search']) ? count($venues->find_by_query("SELECT * FROM venue ORDER BY id DESC")) : count($venues::find_by_query($sql));
// $items_total_count = $venues->count_all();
...
$sql = ($search=='') || !isset($_GET['search']) ? "SELECT * FROM venue ORDER BY id DESC" : $sql;
